...
class XLerobot(Robot):
    ...
    def configure(self):
        ...
        self.bus1.write("Operating_Mode", "head_motor_1", OperatingMode.VELOCITY.value)
    ...
    def get_observation(self) -> dict[str, Any]:
        ...
        # MODIFICATION: Read velocity for head_motor_1
        head_vel_raw = self.bus1.sync_read("Present_Velocity", self.head_motors)
        ...
        head_state = {f"{k}.vel": v for k, v in head_vel_raw.items()}
